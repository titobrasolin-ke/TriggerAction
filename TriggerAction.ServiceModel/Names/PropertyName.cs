...
namespace TriggerAction.ServiceModel.Names
{
    public static class PropertyName
    {
        ...
        [Description("indirizzo senza numero civico (adimensionale, string)")]
        public static readonly string Address = "Address";
        [Description("numero civico di un indirizzo es. 8, 7a, snc (adimensionale, string)")]
        public static readonly string AddressNumber = "AddressNumber";
        [Description("Fascia di età (adimensionale, string)")]
        ...
        [Description("tipo di appliance associata alla smart plug/switch es. lavatrice, televisione, lampada (adimensionale, string)")]
        public static readonly string ApplianceCode = "ApplianceCode";
        [Description("vincolo architettonico : si / no / non so (adimensionale, string)")]
        ...
        [Description("Codice identificativo dell'anomalia dell'edificio. (adimensionale, string)")]
        public static readonly string BuildingEnergyAnomalyCode = "BuildingEnergyAnomalyCode";
        [Description("Numero di anomalie con priorità alta, riscontrate in un edificio (adimensionale, integer)")]
        public static readonly string BuildingEnergyHighAnomalies = "BuildingEnergyHighAnomalies";
        [Description("Numero di anomalie con priorità bassa, riscontrate in un edificio (adimensionale, integer)")]
        public static readonly string BuildingEnergyLowAnomalies = "BuildingEnergyLowAnomalies";
        [Description("Numero di anomalie con priorità media, riscontrate in un edificio (adimensionale, integer)")]
        public static readonly string BuildingEnergyMeanAnomalies = "BuildingEnergyMeanAnomalies";
        [Description("Identificatore dell'edificio (adimensionale, string)")]
        public static readonly string BuildingID = "BuildingID";
        [Description("Etichetta associata all'edificio (adimensionale, string)")]
        public static readonly string BuildingName = "BuildingName";
        [Description("periodo di costruzione di un edificio es. 1981-1992 (adimensionale, string)")]
        public static readonly string BuildingPeriodCode = "BuildingPeriodCode";
        [Description("tipologia di edificio es. : residenziale, scuola, caserma, ospedale, ... (adimensionale, string)")]
        ...
        [Description("dato catastale immobile : particella (adimensionale, string)")]
        public static readonly string CadastralParcel = "CadastralParcel";
        [Description("dato catastale immobile : foglio (adimensionale, string)")]
        public static readonly string CadastralSheet = "CadastralSheet";
        [Description("dato catastale immobile : subalterno (adimensionale, string)")]
        ...
        [Description("Indicatore urbano su illuminazione pubblica (adimensionale, string)")]
        ...
        [Description("Pattern di comunicazione (valori possibili: \"Push\", \"Request Response\", \"Pubblish Subscribe\") (adimensionale, enumeration)")]
        public static readonly string CommunicationPattern = "CommunicationPattern";
        [Description("anno di costruzione di un edificio (se noto) (adimensionale, integer)")]
        ...
        [Description("Descrizione testuale dei dati inviati (adimensionale, string)")]
        public static readonly string DataDescription = "DataDescription";
        [Description("URL dello Schema del Formato con cui si invieranno i dati (adimensionale, string)")]
        public static readonly string DataFormat = "DataFormat";
        [Description("Codice identificativo dell'anomalia del device (adimensionale, string)")]
        public static readonly string DeviceAnomalyCode = "DeviceAnomalyCode";
        [Description("Identificatore del device (adimensionale, string)")]
        public static readonly string DeviceID = "DeviceID";
        [Description("Numero totale delle anomalie individuate su un device (adimensionale, integer)")]
        ...
        [Description("Uso finale dell'energia elettrica consumata (ad es. illuminazione, forza motrice, generale, condizionamento,…) (adimensionale, string)")]
        public static readonly string ElectricityEndUseCode = "ElectricityEndUseCode";
        [Description("Identificativo del quadro elettrico (adimensionale, string)")]
        ...
        [Description("Ora di fine di una fascia oraria (adimensionale, Time)")]
        public static readonly string EndTimeSlot = "EndTimeSlot";
        [Description("Marca temporale indicante la fine del periodo (adimensionale, dateTime)")]
        public static readonly string end_ts = "end_ts";
        [Description("Identificativo del sistema energetico (o macchina o apparecchio) (adimensionale, string)")]
        ...
        [Description("Nome che identifica la tecnologia del sistema energetico (adimensionale, string)")]
        public static readonly string EnergySystemTechnologyName = "EnergySystemTechnologyName";
        [Description("Valutazione del valore del KPI/indicatore es. 'ok’, ‘fuori soglia’, ‘non disponibile’ (adimensionale, string)")]
        ...
        [Description("Identificazione del piano specifico di un edificio (adimensionale, integer)")]
        public static readonly string FloorNumber = "FloorNumber";
        [Description("Formato wgs84 in cui sono espresse le coordinate (attributo opzionale) (adimensionale, string)")]
        public static readonly string format = "format";
        [Description("Consumo gas (cubicMetre, double)")]
        public static readonly string GasConsumption = "GasConsumption";
        [Description("Genere (adimensionale, string)")]
        public static readonly string GenderCode = "GenderCode";
        [Description("Identificatore del Gruppo del social network (adimensionale, string)")]
        public static readonly string GroupID = "GroupID";
        [Description("Nome del Gruppo del social network (adimensionale, string)")]
        public static readonly string GroupName = "GroupName";
        [Description("Link (url) al Gruppo del social network (adimensionale, string)")]
        public static readonly string GroupURL = "GroupURL";
        [Description("Altitudine (proprieta' opzionale) (adimensionale, double)")]
        ...
        [Description("Valore calcolato per l'indicatore (adimensionale, double)")]
        public static readonly string IndicatorValue = "IndicatorValue";
        [Description("Indice di Qualità dell'Aria Indoor (adimensionale, double)")]
        ...
        [Description("Valore calcolato per il KPI specifico (adimensionale, double)")]
        public static readonly string KPIValue = "KPIValue";
        [Description("vincolo paesaggistico : si / no / non so (adimensionale, string)")]
        public static readonly string LandscapeConstraint = "LandscapeConstraint";
        [Description("Latitudine (adimensionale, double)")]
        ...
        [Description("Identificativo dell'area osservata. (adimensionale, string)")]
        public static readonly string LocationID = "LocationID";
        [Description("Denominazione luogo (adimensionale, string)")]
        public static readonly string LocationName = "LocationName";
        [Description("Codice che indica lo stato dell'\"oggetto\" monitorato (adimensionale, string)")]
        public static readonly string LogCode = "LogCode";
        [Description("Descrizione testuale dello stato dell'oggetto monitorato (adimensionale, string)")]
        public static readonly string LogDescription = "LogDescription";
        [Description("Longitudine (adimensionale, double)")]
        ...
        [Description("Numero di iscritti al Gruppo (adimensionale, integer)")]
        public static readonly string MemberCount = "MemberCount";
        [Description("Nome della stazione Meteo che ha fornito i dati (adimensionale, string)")]
        public static readonly string MeteoStationName = "MeteoStationName";
        [Description("Identificativo univoco del contatore (adimensionale, string)")]
        public static readonly string MeterID = "MeterID";
        [Description("Identificativo dello schema di codifica a cui appartiene l'identificativo fornito nel campo MeterID (adimensionale, string)")]
        ...
        [Description("Nome della stazione di monitoraggio che ha fornito i dati (adimensionale, string)")]
        public static readonly string MonitoringStationName = "MonitoringStationName";
        [Description("Nazionalità (adimensionale, string)")]
        ...
        [Description("Efficienza nominale del sistema (adimensionale, double)")]
        ...
        [Description("Numero di Occupanti di un ambiente confinato (adimensionale, integer)")]
        ...
        [Description("Identificatore della Pagina del social network (adimensionale, string)")]
        public static readonly string PageID = "PageID";
        [Description("Numero di \"Like\" ricevuti dalla pagina (adimensionale, integer)")]
        public static readonly string PageLikeCount = "PageLikeCount";
        [Description("Nome della Pagina del social network (adimensionale, string)")]
        public static readonly string PageName = "PageName";
        [Description("Link (url) alla Pagina del social network (adimensionale, string)")]
        public static readonly string PageURL = "PageURL";
        [Description("Codice PDR cui è associata l'utenza (adimensionale, string)")]
        public static readonly string PDRID = "PDRID";
        [Description("KPI tecnici specifici del PELL IP (adimensionale, string)")]
        ...
        [Description("Qualificatore che descrive il periodo (adimensionale, string)")]
        public static readonly string PeriodQualifierCode = "PeriodQualifierCode";
        [Description("Periodo espresso come valore (es. il giorno della settimana, l'anno, ecc.) (adimensionale, string)")]
        ...
        [Description("Indica la categoria (persone, veicoli) alla quale si riferisce il conteggio (adimensionale, string)")]
        public static readonly string PhysicalUnitCategoryCode = "PhysicalUnitCategoryCode";
        [Description("Identificatore dell'impianto (adimensionale, string)")]
        public static readonly string PlantID = "PlantID";
        [Description("Nome dell'impianto (adimensionale, string)")]
        public static readonly string PlantName = "PlantName";
        [Description("Identificatore della piattaforma software (adimensionale, string)")]
        public static readonly string PlatformID = "PlatformID";
        [Description("Nome della piattaforma software (adimensionale, string)")]
        public static readonly string PlatformName = "PlatformName";
        [Description("Identificatore della zona omogenea secondo criteri illuminotecnici di un area urbana con illuminazione pubblica (adimensionale, string)")]
        ...
        [Description("indice PMV (predicted mean vote) della misura del confort indoor secondo la scala [-3,+3] (adimensionale, double)")]
        public static readonly string PMV = "PMV";
        [Description("Codice POD che identifica univocamente il punto di prelievo (adimensionale, string)")]
        public static readonly string PODID = "PODID";
        [Description("Numero di reazioni ai post pubblicati. (adimensionale, integer)")]
        public static readonly string PostReactionCount = "PostReactionCount";
        [Description("Numero di risposte ai post pubblicati. (adimensionale, integer)")]
        public static readonly string PostReplyCount = "PostReplyCount";
        [Description("Numero di utenti che hanno visualizzato i post della pagina (adimensionale, integer)")]
        public static readonly string PostVisualizationCount = "PostVisualizationCount";
        [Description("Fattore di potenza (adimensionale, double)")]
        public static readonly string PowerFactor = "PowerFactor";
        [Description("Fattore di potenza R (adimensionale, double)")]
        public static readonly string PowerFactorPhase1 = "PowerFactorPhase1";
        [Description("Fattore di potenza S (adimensionale, double)")]
        public static readonly string PowerFactorPhase2 = "PowerFactorPhase2";
        [Description("Fattore di potenza T (adimensionale, double)")]
        public static readonly string PowerFactorPhase3 = "PowerFactorPhase3";
        [Description("Probabilità, espressa in percentuale, con cui si verificheranno delle precipitazioni. (adimensionale, double)")]
        public static readonly string PrecipitationProbabilityPercentage = "PrecipitationProbabilityPercentage";
        [Description("Numero di presenze rilevato (adimensionale, integer)")]
        public static readonly string PresenceCount = "PresenceCount";
        [Description("Percentuale di tempo in cui un ambiente ha avuto la presenza di almeno una pesona (adimensionale, double)")]
        public static readonly string PresencePercentage = "PresencePercentage";
        [Description("Numero di dispositivi di localizzazione (adimensionale, integer)")]
        public static readonly string PresenceScannerCount = "PresenceScannerCount";
        [Description("Codice Provincia (adimensionale, string)")]
        ...
        [Description("Identificativo dell'unità immobiliare (es. appartamento, edificio, abitazione indipendente...) (adimensionale, string)")]
        public static readonly string RealEstateUnitID = "RealEstateUnitID";
        [Description("numero di unità immobiliari (adimensionale, integer)")]
        public static readonly string RealEstateUnits = "RealEstateUnits";
        [Description("Codice Regione (adimensionale, string)")]
        public static readonly string RegionCode = "RegionCode";
        [Description("Umidità relativa dell'aria espressa in percentuale. (adimensionale, double)")]
        public static readonly string RelativeHumidity = "RelativeHumidity";
        [Description("Tipologia di stanza in cui sensore è installato es. cucina, bagno, ufficio (adimensionale, string)")]
        public static readonly string RoomCode = "RoomCode";
        [Description("Codice che identifica una stanza (adimensionale, string)")]
        public static readonly string RoomID = "RoomID";
        [Description("Identificativo di uno schema di identificazione utilizzato (adimensionale, string)")]
        public static readonly string SchemeID = "SchemeID";
        [Description("identificativo univoco del sensore es. serial number, mac address (adimensionale, string)")]
        public static readonly string SensorID = "SensorID";
        [Description("marca/modello (codice) del sensore (adimensionale, string)")]
        public static readonly string SensorName = "SensorName";
        [Description("tipologia di sensore che effettua la misura es. smart plug, smart switch, presence, ... (adimensionale, string)")]
        ...
        [Description("Nome o identificatore del social network a cui sono riferiti i dati (adimensionale, string)")]
        ...
        [Description("Ora di inizio di una fascia oraria (adimensionale, Time)")]
        public static readonly string StartTimeSlot = "StartTimeSlot";
        [Description("Marca temporale indicante l'inizio del periodo (adimensionale, dateTime)")]
        public static readonly string start_ts = "start_ts";
        [Description("Nome di un'area all'interno di un luogo (adimensionale, string)")]
        ...
        [Description("Fascia oraria espressa come valore. Valori suggeriti \"diurna\", \"notturna\", dove se non diversamente specificato tramite \"Ora inizio\" e \"Ora fine\", si assume che: - diurna: dalle 07:00 alle 18:59 - notturna: dalle 19:00 alle 06:59 (adimensionale, string)")]
        public static readonly string TimeSlotDescription = "TimeSlotDescription";
        [Description("Numero totale UrbanDataset acceduti (adimensionale, integer)")]
        ...
        [Description("Percentuale di copertura nuvolosa sul totale. (adimensionale, double)")]
        public static readonly string TotalCloudCoveragePercentage = "TotalCloudCoveragePercentage";
        [Description("Indica se il numero di presenze indicato è un totale (true) o un parziale (false) per il periodo indicato. (adimensionale, boolean)")]
        public static readonly string TotalCountFlag = "TotalCountFlag";
        [Description("Numero degli utenti gestiti (adimensionale, integer)")]
        public static readonly string TotalManagedUsersCount = "TotalManagedUsersCount";
        [Description("Numero delle applicazioni verticali gestite (adimensionale, integer)")]
        public static readonly string TotalManagedVerticalsCount = "TotalManagedVerticalsCount";
        [Description("Numero totale UrbanDataset prodotti (adimensionale, integer)")]
        ...
        [Description("codice ISTAT del comune (adimensionale, string)")]
        public static readonly string TownCode = "TownCode";
        [Description("Nome esteso del Comune es. Roma, Anguillara Sabazia, ... (adimensionale, string)")]
        public static readonly string TownName = "TownName";
        [Description("Codice identificativo dell'anomalia dell'impianto. (adimensionale, string)")]
        public static readonly string TreatmentPlantAnomalyCode = "TreatmentPlantAnomalyCode";
        [Description("dato catastale immobile : sezione urbana (adimensionale, string)")]
        public static readonly string UrbanSection = "UrbanSection";
        [Description("Nome della solution verticale (adimensionale, string)")]
        ...
        [Description("Parametro che definisce la situazione meteo (pioggia, neve, sereno, coperto,…) (adimensionale, string)")]
        public static readonly string WeatherConditionCode = "WeatherConditionCode";
        [Description("Descrizione testuale della situazione meteo. (adimensionale, string)")]
        ...
        [Description("Stato della finestra (aperto o chiuso) (adimensionale, string)")]
        ...
        [Description("Indica se si fa riferimento a giorni feriali o festivi. (adimensionale, boolean)")]
        public static readonly string WorkingDayFlag = "WorkingDayFlag";
        [Description("URL dell'endpoint del Web Service a cui si vuole accedere (adimensionale, string)")]
        public static readonly string WSEndpoint = "WSEndpoint";
        [Description("Codice di Avviamento Postale (CAP) eccezione nelle regole di naming in quanto non ha associato nessuna lista .gc (adimensionale, string)")]
